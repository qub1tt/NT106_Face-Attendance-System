...
"border-radius: 20px;")
        ...
        self.lbl_image.setPixmap(QtGui.QPixmap("Anh/changepassword.png"))
...
"padding: 10px; ")
        ...
        self.label_9.setPixmap(QtGui.QPixmap("Anh/reset-password-icon.png"))
        ...
        self.label_10.setPixmap(QtGui.QPixmap("Anh/lock_icon.png"))
